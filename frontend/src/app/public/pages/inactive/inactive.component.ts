    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div class="text-center max-w-md">
        ...
        <p class="text-[color:var(--color-text-muted)] mb-6">
          This store is temporarily unavailable. Please contact the admin to renew the subscription.
        </p>
        <a href="https://wa.me/201226187060" target="_blank" rel="noopener"
           class="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg transition mb-4">
