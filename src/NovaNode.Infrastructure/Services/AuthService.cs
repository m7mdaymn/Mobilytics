...
public class AuthService : IAuthService
{
    ...
    public async Task<LoginResponse> LoginAsync(Guid tenantId, LoginRequest request, CancellationToken ct = default)
    {
        ...
        var token = GenerateJwt(employee.Id, employee.Email, employee.Role, tenantId, permissions);
    ...
    private string GenerateJwt(Guid userId, string email, string role, Guid tenantId, List<string> permissions)
    {
